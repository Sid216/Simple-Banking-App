CREATE TABLE IF NOT EXISTS IS601_Bank_Transaction(
    ...
    FOREIGN KEY (account_src) REFERENCES IS601_S_Accounts(id),
    FOREIGN KEY(account_dest) REFERENCES IS601_S_Accounts(id),
